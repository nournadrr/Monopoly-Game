...
public class MonopolyGame {    
    public static newgame n = new newgame();
    public static loadgame l=new loadgame();
    public static void main(String[] args) throws FileNotFoundException, IOException, ClassNotFoundException {
//        new graphics();
        
                Object[] s=new Property[28];
...
//        p[3].decrementBalance(1498);
        ...
        ((Property)a[23]).setOwnerid(0);
        ((Property)a[26]).setOwnerid(0);
        new board(p,a,"");


//        ((Cities)a[2]).incrementHousecounter();
//        ((Cities)a[2]).incrementHousecounter();
//        ((Cities)a[2]).incrementHousecounter();
//        ((Cities)a[2]).incrementHousecounter();
//        ((Property)a[26]).setOwnerid(0);
